...
void torch_FusedConvSelectKLauncher(
	...
	torch::Tensor idx_fetching_tensor,
	...
	CHECK_INPUT(idx_fetching_tensor);
	...
	const int *idx_fetching = idx_fetching_tensor.data<int>();
	...
	stride_h, stride_w, xyz1, xyz2, idx_n2, idx_fetching, random_hw, selected_b_idx, selected_h_idx, selected_w_idx, selected_mask, small_h, small_w, stream);
}
